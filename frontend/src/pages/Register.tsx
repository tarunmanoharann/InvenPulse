      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground text-center">
            ...
            <Link to="/terms" className="text-blue-500 hover:underline mx-1">Terms of Service</Link>
            and
            <Link to="/privacy" className="text-blue-500 hover:underline mx-1">Privacy Policy</Link>
          </p>
        </CardContent>
